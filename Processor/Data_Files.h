...
enum Dtype { DATA_TRIPLE, DATA_SQUARE, DATA_BIT, DATA_INVERSE, DATA_BITTRIPLE, DATA_BITGF2NTRIPLE,
  DATA_RAND, DATA_RAND2, DATA_RANDRANGE, DATA_RANDEXP, DATA_RANDBIT, N_DTYPE };
