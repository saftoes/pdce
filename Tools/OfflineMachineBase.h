...
public:
    ...
    long long nrands, nRandsPerThread;
    long long nrand2s, nRand2sPerThread;
    long long nranges, nRandRangesPerThread, l;
    long long nexps, nRandExpsPerThread, exp;
    long long nbits, nRandBitsPerThread;
    bool output;
